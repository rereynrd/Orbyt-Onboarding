...
const DEFAULT_QUESTIONS = [
  {
    ...
    type: "text",
    orb: "listening",
    bubbles: ["Hey — I'm Orby!", "What should I call you?"],
  ...
  },
  {
    ...
    type: "choice",
    orb: "curious",
    bubbles: (ctx) => [`Hi, ${ctx.name || "friend"}.`, "What are you studying?"],
    options: [
  ...
  },
  {
    ...
    options: [
      { v: "procrastination", label: "Procrastination", icon: "⏰" },
  ...
  // ============ OPEN-ENDED (5) ============
  {
    ...
    type: "text",
    orb: "curious",
    bubbles: ["A class you secretly love — or hate?", "One sentence on why."],
    placeholder: "e.g. Organic Chem — the puzzles, not the hours…",
    multiline: true,
  },
  {
    id: "wishBetter",
    type: "text",
    orb: "thinking",
    bubbles: ["Something you wish you were better at, academically?"],
    placeholder: "e.g. reading without re-reading three times…",
    multiline: true,
  },
  {
    id: "pastHabit",
    type: "text",
    orb: "curious",
    bubbles: ["A study habit that once worked — or failed spectacularly."],
    placeholder: "e.g. the all-nighter that ruined finals week…",
    multiline: true,
  },
  {
    id: "forWho",
    ...
    placeholder: "e.g. me, my family, my future self…",
    multiline: true,
  },
  {
    id: "successLook",
    type: "text",
    orb: "happy",
    bubbles: ["What does success this semester look like?", "Be specific."],
    placeholder: "e.g. A- in calc, no 3am panic, two Saturdays off…",
    multiline: true,
  },
];

// buildStudyDNA is now provided by dna-catalog.jsx — stub kept for load-order safety
const buildStudyDNA_STUB = (answers) => {
  const struggleMap = {
...
Object.assign(window, {
  ...
  DEFAULT_QUESTIONS,
  // buildStudyDNA is overridden by dna-catalog.jsx loaded after this file
  buildStudyDNA: buildStudyDNA_STUB,
});
